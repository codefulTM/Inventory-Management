// === FormPage.tsx ===
// Trang tạo/chỉnh sửa lô sản xuất (Production Batch)
// Key methods: handleSubmit (create/update), fetchProductionBatch, fetchMaterials
// API: productionBatchService, materialService

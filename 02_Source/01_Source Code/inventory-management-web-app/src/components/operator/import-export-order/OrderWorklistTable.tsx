...
// Bảng danh sách phiếu kho (Warehouse Slip) với phân trang, xác nhận/từ chối
// Key methods: loadData, formatDate, mapSlipStatus
// API: fetchWarehouseSlips (warehouseSlipService)

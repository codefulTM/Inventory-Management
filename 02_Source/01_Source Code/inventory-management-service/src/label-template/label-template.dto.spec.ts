...
describe('LabelTemplate DTOs Validation', () => {
  describe('CreateLabelTemplateDto', () => {
    describe('template_id validation', () => {
      ...
      it('should accept missing template_id (auto-generated by server)', async () => {
        const dto = plainToInstance(CreateLabelTemplateDto, {
          template_id: '',
          template_name: 'Raw Material',
          label_type: 'Raw Material',
        ...
        // template_id is optional; empty string is allowed (will be auto-generated)
        const templateIdErrors = errors.filter((e) => e.property === 'template_id');
        expect(templateIdErrors).toHaveLength(0);
      })

      it('should accept when template_id is omitted (auto-generated by server)', async () => {
        const dto = plainToInstance(CreateLabelTemplateDto, {
          template_name: 'Raw Material',
          label_type: 'Raw Material',
          template_content: 'Content',
  ...
  describe('Large parameterized datasets', () => {
    ...
    it.each(['123456789012345678901', 123, true, {}, []])(

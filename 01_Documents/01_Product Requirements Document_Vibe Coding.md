...
-> Mục đích chung: Phân tích nghiệp vụ, làm rõ yêu cầu
...
-> Mục đích chung: Là phần phản biện để chọn giải pháp có cơ sở, không theo cảm tính.

### 3.3 Giai đoạn chốt phạm vi

### Prompt 5 - Chốt MVP(sản phẩm khả dụng tối thiểu) theo role
